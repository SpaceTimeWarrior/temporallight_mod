...
public class HyperSteel_Slab extends BlockSlab {
    public static final String[] field_150005_b = new String[] {"hypersteel"};
    public HyperSteel_Slab(Material material, boolean opaque) {
        super(opaque,material);
        this.setHarvestLevel("pickaxe", TLConfig.harvest_lv_floor);
