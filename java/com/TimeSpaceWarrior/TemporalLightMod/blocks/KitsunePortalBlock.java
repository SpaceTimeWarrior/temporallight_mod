...
public class KitsunePortalBlock extends Block {
    public KitsunePortalBlock(Material portalmat) {
        super(portalmat);
   ...
   /* protected boolean func_150857_a(Block block) {
        return block.getMaterial() == Material.air || block == Blocks.fire || block == BlockRegistry.KITSUNEPORTAL;
    }*/
