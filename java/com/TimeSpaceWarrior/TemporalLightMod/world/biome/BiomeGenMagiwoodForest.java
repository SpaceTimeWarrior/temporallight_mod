...
public class BiomeGenMagiwoodForest extends BiomeGenBase {
    public BiomeGenMagiwoodForest(int id) {
        super(id);
        this.setEnableSnow();
        this.spawnableMonsterList.add(new BiomeGenBase.SpawnListEntry(EntitySkeleton.class, 1, 1, 2));
        this.spawnableMonsterList.add(new BiomeGenBase.SpawnListEntry(EntityCreeper.class, 2, 2, 4));
