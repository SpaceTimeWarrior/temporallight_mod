package net.tsw.Temporal_Light.world.biome;
...
//    BiomeDefaultFeatures
    ...
    public static void boostap(BootstapContext<Biome> context) {
    ...
    private static Biome Bunny_Hop_Mountains(BootstapContext<Biome> context) {
    ...
    private static Biome Water_Dragon_Seas(BootstapContext<Biome> context) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
//        spawnBuilder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(TLEntityRegistry.KITSUNE.get(), 1, 3, 5));
    ...
    private static Biome Phoenix_Jungle(BootstapContext<Biome> context) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
        spawnBuilder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(TLEntityRegistry.KITSUNE.get(), 1, 3, 5));
        spawnBuilder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(TLEntityRegistry.PHOENIX_F.get(),6,1,3));
        spawnBuilder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(EntityType.WOLF, 5, 4, 4));
    ...
    public static Biome Kitsune_Highlands(BootstapContext<Biome> context) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
        spawnBuilder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(TLEntityRegistry.KITSUNE.get(), 2, 3, 5));
