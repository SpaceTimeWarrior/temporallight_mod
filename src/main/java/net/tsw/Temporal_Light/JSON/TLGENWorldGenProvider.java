...
public class TLGENWorldGenProvider extends DatapackBuiltinEntriesProvider {
    ...
    public TLGENWorldGenProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
