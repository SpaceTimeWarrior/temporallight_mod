package net.tsw.Temporal_Light.villager;
...
public class TLVillagerRegistry {
    ...
    public static final RegistryObject<PoiType> END_POI = POI_TYPES.register("end_poi",()->new PoiType(ImmutableSet.copyOf(TLBlocksRegistry.ERESPAWNANCHOR.get().getStateDefinition().getPossibleStates()),1,6));
