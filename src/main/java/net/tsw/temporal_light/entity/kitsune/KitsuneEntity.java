...
import net.tsw.temporal_light.entity.AI.KitsuneAttackGoal;
import net.tsw.temporal_light.entity.AI.KitsuneFireballGoal;
...
//comented out debug output for less lag
    ...
    protected void defineSynchedData(SynchedEntityData.Builder pBuilder) {
        ...
        pBuilder.define(NIGHT_FORM, false);
        pBuilder.define(TRANSFORMING, false);
        pBuilder.define(TARGET_UUID, Optional.empty());
        pBuilder.define(VARIENT,0);
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new TemptGoal(this, 1.75, stack -> stack.is(Items.SWEET_BERRIES), false));
