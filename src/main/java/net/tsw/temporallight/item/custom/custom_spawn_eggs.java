...
public class custom_spawn_eggs extends SpawnEggItem {
    protected static final List<custom_spawn_eggs> UNADDED_EGGS = new ArrayList<>();
    private final Lazy<? extends EntityType<?>> entityTypeSupplier;

    public custom_spawn_eggs(final RegistryObject <?extends EntityType<?>> entityTypeSupplier, int primaryColorIn, int secondaryColorIn, Properties builder) {
