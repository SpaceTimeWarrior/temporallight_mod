...
public class TLCustomBowItem extends BowItem {
    public int type;
    public TLCustomBowItem(Properties p_i48522_1_,int type) {
        super(p_i48522_1_);
        this.type = type;
    }
    public TLCustomBowItem(Properties p_i48522_1_) {
        super(p_i48522_1_);
    }
    @Override
            ...
            if (!itemstack.isEmpty() || flag) {
                ...
                if (!((double)f < 0.1D)) {
                    ...
                    if (!worldIn.isRemote) {
                        ...
                        abstractarrowentity.setFire(100+100*type);
