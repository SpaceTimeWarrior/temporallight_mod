...
public enum armormaterialregistry implements IArmorMaterial {
    HYPERSTEEL("hypersteel",44,new int[]{6, 12, 16, 6},30, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE,6F,0.2F,()->{
        return Ingredient.fromItems(ItemRegistry.HYPERSTEELINGOT.get());
    }),
    TIMECRYSTAL("hypersteel",44,new int[]{36, 72, 96, 36},120, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE,12F,1F,()->{
        return Ingredient.fromItems(ItemRegistry.TIMECRYSTALSHARD.get());
    });
