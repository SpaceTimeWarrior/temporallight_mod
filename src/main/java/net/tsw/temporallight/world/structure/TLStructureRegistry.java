package net.tsw.temporallight.world.structure;
...
public class TLStructureRegistry {
    public static final DeferredRegister<Structure<?>> STRUCTURES =
            DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, TemporalLight.MOD_ID);
