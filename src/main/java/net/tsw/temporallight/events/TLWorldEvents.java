...
import net.tsw.temporallight.world.Gen.*;
...
@Mod.EventBusSubscriber(modid = TemporalLight.MOD_ID)
public class TLWorldEvents {
    @SubscribeEvent
    ...
    public static void addDimensionalSpacing(final WorldEvent.Load event) {
        if(event.getWorld() instanceof ServerWorld) {
            ...
            tempMap.putIfAbsent(TLStructureRegistry.MAGIWOODTREE.get(),
                    DimensionStructuresSettings.field_236191_b_.get(TLStructureRegistry.MAGIWOODTREE.get()));
