...
import net.tsw.temporallight.block.custom.tree.TLBushBlock;

public class TLSaplingBlock extends TLBushBlock implements IGrowable {
    public static final IntegerProperty STAGE = BlockStateProperties.STAGE_0_1;
    protected static final VoxelShape SHAPE = Block.makeCuboidShape(2.0D, 0.0D, 2.0D, 14.0D, 12.0D, 14.0D);
    private final Tree tree;

    public TLSaplingBlock(Tree treeIn, AbstractBlock.Properties properties) {
        super(properties);
        this.tree = treeIn;
