...
public class c4wayblock extends customBlock {
    ...
    public c4wayblock(float nodeWidth, float extensionWidth, float nodeHeight, float extensionHeight, float collisionY, AbstractBlock.Properties properties) {
        super(properties);
